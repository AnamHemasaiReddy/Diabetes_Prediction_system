...
Pregnancies = st.sidebar.number_input("Pregnancies", 0, 10, 2)
Glucose = st.sidebar.slider("Glucose Level", 0, 400, 120)
BloodPressure = st.sidebar.slider("Blood Pressure (mm Hg)", 0, 180, 70)
